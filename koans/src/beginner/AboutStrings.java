...
public class AboutStrings {
    ...
    public void implicitStrings() {
        assertEquals("just a plain ole string".getClass().toString(), "class java.lang.String" );
    }
    ...
    public void insufficientArgumentsToStringFormatCausesAnError() {
        try {
            ...
            assertEquals(e.getClass().toString(), "class java.util.MissingFormatArgumentException");
